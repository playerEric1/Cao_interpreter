...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "OPA", "OPM",
  "LP", "RP", "STOP", "$accept", "run", "res", "exp", "term", "sfactor",
  "factor", YY_NULLPTR
};
...
#line 37 "test.y"
                      { (yyval.val) = (yyvsp[0].val); }
#line 1123 "test.tab.c"
    break;

  case 12: /* factor: LP exp RP  */
#line 38 "test.y"
                      { (yyval.val) = (yyvsp[-1].val); }
#line 1129 "test.tab.c"
    break;
